...
# This is a modified version to support an additional argument, the specific
# optimizer type.
# The options can be sgd, adam, rmsprop for the optimizer
# Refer to the torch.optim documentation for more details
...
def main():
    ...
    # Next section is the optimizer argument parse
    parser.add_argument(
        "--optimizer",
        type=str,
    ...
    # cases to consider the choices of the arg optimizer
